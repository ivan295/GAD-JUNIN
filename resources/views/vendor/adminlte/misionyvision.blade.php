...
<body>
    ...
    <section id=mision>
        <div id="misiontext">
            <p id="titulo-mision">MISIÓN</p>
            Mejorar el bienestar social y
            material de la colectividad, sirviendo de manera eficiente y transparente
            como institución planificadora, gestionadora, ejecutora de obras de
            infraestructuras, reguladora y facilitadora del desarrollo y crecimiento
            integral humano; para así, de esta manera contribuir al progreso del cantón Junín,
            convirtiendolo en un territorio del buen vivir.
           
            <p id="vision-titulo">VISIÓN</p>
            El Gobierno Autónomo Descentralizado Municipal
            del cantón Junín, cumpliendo progresivamente las
            misiones planteadas hasta el 2020, procurando ser
            una institución moderna, competitiva de alta productividad,
            de reconocido prestigio y referente valido de gestión transparente.
            Mejorando la calidad y modo de vida; promoviendo, planificando e
            impulsando el desarrollo económico, social, medio ambiental, cultural,
            salud, turismo y deportivo del cantón Junín, a través de las mancomunidades.
            Trabajando en equipo con sostenibilidad presupuestaria, participación ciudadana,
            comunicación efectiva; y, en el compromiso y capacidad de sus talentos humanos.
    
        </div>
        <div id="imagen">
            <img id="municipio" src="img/municipio.jpg" alt="">
        </div>
